...
public class Ex19 {
    public static void main(String[] args) {
        ...
        library.addBook(new Book("978-4", "이펙티브 자바", "남궁성", 36000));
        library.addBook(new Book("978-5", "이펙티브 자바", "조슈아", 36000));
        library.addBook(new Book("978-6", "이펙티브 자바", "남궁성", 36000));
        library.addBook(new Book("978-7", "이펙티브 자바", "김영한", 36000));

        Book foundBook = library.findByIsbn("978-2");
        System.out.println(foundBook);

        library.findByAuthor(searchAuthor).forEach(System.out::println);
        library.findByPriceRange(35000, 36000).forEach(System.out::println);
    }
}
