...
public class Ex06 {
    public static void main(String[] args) {
        int currentStudentNumber = 20260000;
        List<Student> studentList = List.of(
                Student.builder().studentYear(1).name("김준일").korScore(80).engScore(90).mathScore(100).build(),
                Student.builder().studentYear(2).name("김준이").korScore(70).engScore(80).mathScore(90).build(),
                Student.builder().studentYear(1).name("김준삼").korScore(90).engScore(80).mathScore(70).build(),
                Student.builder().studentYear(2).name("김준사").korScore(60).engScore(70).mathScore(80).build()
        );
